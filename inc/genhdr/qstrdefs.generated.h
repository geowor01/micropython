...
QDEF(MP_QSTR_javascript, (const byte*)"\x36\x0a" "javascript")
QDEF(MP_QSTR_join, (const byte*)"\xa7\x04" "join")
QDEF(MP_QSTR_js_function_type, (const byte*)"\x06\x10" "js_function_type")
...
QDEF(MP_QSTR_new_function, (const byte*)"\xa4\x0c" "new_function")
QDEF(MP_QSTR_new_module, (const byte*)"\x3c\x0a" "new_module")
QDEF(MP_QSTR_new_var, (const byte*)"\xc3\x07" "new_var")
